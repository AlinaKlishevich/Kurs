...
<div class="header">
    ...
    <p style="font-size: 16px; font-family: cursive; color: black; position: absolute; top: 160px">Вы находитесь на
        странице создания записи.</p>
</div>

<div class="sidebar">
    <h3 class="sidetextCreate"> Заполните информацию о нарушении</h3>


    <div class="create">
        <form action="${pageContext.request.contextPath}/createrecord" method="post" >


            <input class="numberauto" type="text" name="numberauto" placeholder="Номер автомобиля" size="60"
                   required></br>
