...
<div class="sidebar">
    <h3 class="vsidetext">Введите номер протокола</h3>
    <div class="search">
        <form action="${pageContext.request.contextPath}/searchvio" method="GET">
            <input class="" type="text" name="idviolations" value="" placeholder="Номер протокола" size="60"
                   required></br>
