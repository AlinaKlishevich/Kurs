...
<p style="font-size: 16px; font-family: cursive; color: black; position: absolute; top: 160px">Проверка авторизации</p>
...
<div class="sidebar">
    ...
    /*color: rgba(43,45,48,0.95);*/
    font-family: 'Courier New';
    color: black">Пользователь с таким логином уже существует!</h1>
