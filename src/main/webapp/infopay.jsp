...
<div class = "sidebar">
    <p style="font-size: 18px; font-family: cursive; text-align: center; color: white">Данные о пользователях </p>
    <table>
        <tr>
            <th>ID </th>
        ...
        <c:forEach items="${infopay}" var="pays">
            <tr>
                <td><c:out value="${pays.idpay}" /> </td>
                <td><c:out value="${pays.idviolations}" /> </td>
                <td><c:out value="${pays.sum}"  /> </td>
            </tr>
        </c:forEach>
    </table>
</div>
